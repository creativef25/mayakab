    ...
    <div class="container">
      <div class="row mb-5">
        <div class="col-md-6">
          <div class="block-16">
            <figure>
              <img src="{{ asset('tienda/images/hero_1.jpg')}}" alt="Image placeholder" class="img-fluid">
            </figure>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 order-md-2">
          <div class="block-16">
            <figure>
              <img src="{{ asset('tienda/images/hero_2.jpg')}}" alt="Image placeholder" class="img-fluid ">
