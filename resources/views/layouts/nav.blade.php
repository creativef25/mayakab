    ...
    <div class="navbar-content scroll-div " >
      ...
      <div class="">
        <div class="main-menu-header">
          <img class="img-radius" src="{{ asset('maykab/images/user/avatar-2.jpg')}}" alt="User-Profile-Image">
          ...
          <ul class="list-unstyled">
            ...
            <li class="list-group-item">
              <form class="" action="{{ route('logout') }}" method="post">
                @csrf
                <button class="btn" type="submit" name="button"><i class="feather icon--log-out m-r-5"></i>Logout</button>
              </form>
            </li>
          </ul>
        </div>
      ...
      <ul class="nav pcoded-inner-navbar">
        <li class="nav-item">
          <a href="{{ route('productos')}}" class="nav-link"><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Productos</span> </a>
        </li>
      </ul>
